...
def main():
    """
    Note: ensure to checkout to use sotodlib master and cd to sat-iso/v3
    before running this.
    """
    ...
    preprocess_config_proc_t2p = "preprocessing/satp1/preprocessing_config_20250801_proc_T2Ptemplate.yaml"  # noqa
    ...
    out_dir = "/home/kw6905/bbdev/bb-awg-scripts/users/kwolz/adrien_pr_20251027/out/old_master_corrected"
    fp_thin = 8
    ...
    configs_proc_t2p, ctx_proc = pp_util.get_preprocess_context(
        preprocess_config_proc_t2p
    )
    ...
    print("T2P", len(data_aman.dets.vals))
