...
def main():
    """
    Note: make sure to checkout to sotodlib adrien_pr_20251027
    and pip install . first!
    """
    if os.getcwd() != "/home/kw6905/bbdev/iso-sat/v3":
        print("Please do: \n"
              "cd /home/kw6905/bbdev/iso-sat/v3; "
              f"python {os.path.dirname(os.path.abspath(__file__))}/filter_sims_sotodlib_1atomic_adrien_pr_20251027.py")
        sys.exit()
    ...
    wafer = "ws1"
    preprocess_config_init = "preprocessing/satp1/preprocessing_config_20250801_init_adrien_pr_20251027.yaml"  # noqa
    preprocess_config_proc = "preprocessing/satp1/preprocessing_config_20250801_proc_adrien_pr_20251027.yaml"  # noqa
    ...
    out_dir = "/home/kw6905/bbdev/bb-awg-scripts/users/kwolz/adrien_pr_20251027/out"
    fp_thin = 8
