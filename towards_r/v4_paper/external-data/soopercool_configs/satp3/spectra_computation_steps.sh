...
soopercool_dir=/home/sa5705/software/SOOPERCOOL # Insert path to your local SOOPERCOOL directory
  ...
  for sat_freq in "${sat_freqs[@]}"; do
    for patch in "${patches[@]}"; do
      for split in "${splits[@]}"; do
          ...
          paramfile="towards_r/v4_paper/external-data/soopercool_configs/${sat}/paramfile_${patch}_${split}_filtered_${sat}_${sat_freq}.yaml"
