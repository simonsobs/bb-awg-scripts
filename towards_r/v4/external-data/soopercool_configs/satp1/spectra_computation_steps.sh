  ...
  for sat_freq in "${sat_freqs[@]}"; do
    for patch in "${patches[@]}"; do
      for split in "${splits[@]}"; do
          ...
          srun -n 1 -c 112 python ${soopercool_dir}/pipeline/postproc/fit_EB_angles.py --sacc-file /scratch/gpfs/SIMONSOBS/external_data_e2e/v4/spectra/filtered_${sat}_${sat_freqs}_20260304_fixed_exp_tag/south/20251216_full-dataset/science/saccs/cl_and_cov_sacc_calibrated.fits \
